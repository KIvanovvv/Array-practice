...
dogSarah.curFood < dogSarah.recFood * 0.9 &&
  console.log(`Sarah's dog is not eating enough`);
dogSarah.curFood > dogSarah.recFood * 1.1 &&
...
console.log(dogs.some(dog => okey(dog)));

//7
const dogsEatingOkey = dogs.filter(dog => okey(dog));
